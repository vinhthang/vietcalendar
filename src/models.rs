...
mod tests {
    ...
    fn test_date_month_year_serde() {
        ...
        assert_eq!(parsed, DateMonthYear { dd: 15, mm: 8, yyyy: 2024, leap: None });
        ...
        assert_eq!(parsed_leap, DateMonthYear { dd: 15, mm: 8, yyyy: 2024, leap: Some(true) });
    ...
    fn test_lunar_date_serde() {
        let lunar = LunarDate { day: 1, month: 1, year: 2024, is_leap: false };
